...
Symmetrical Faults - Power System Three-Phase Short Circuits - Example 8.6
(p. 425).
...
# Extra branch between bus 2 and bus 4 with X = 0.075 pu:
nw.add_branch(0.075j, start_node_ID="4", end_node_ID="2")
